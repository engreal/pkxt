...
public class zhuanye_servlet extends HttpServlet {
    ...
    public void zhuanyeEdit(HttpServletRequest req, HttpServletResponse res) {
        String name = req.getParameter("name");
        String jieshao = req.getParameter("jieshao");

        String sql = "update t_zhuanye set name=?,jieshao=? where id=" + Integer.parseInt(req.getParameter("id"));
